...
export default function Card(props){
   return(
    ...
    <div className="card">
      ...
      <Image src= {props.imgLink} alt="image" className="w-40 h-40 rounded-xl hover:scale-110 transition-all ease-in-out object-fill overflow-x-hidden" width={100} height={100}   />
    </Link>
